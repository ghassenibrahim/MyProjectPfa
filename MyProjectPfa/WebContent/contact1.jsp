				...
				<div class="row">
					<div class="col-lg-3">
						<div class="contact_info">
							<%
								Object dispo = request.getAttribute("demande");
							%>
							<div class="info_item">

								<i class="lnr lnr-pointer-right"></i>
								<h6>${demande.getCompte().getUser().getNom()}
									${demande.getCompte().getUser().getPrenom()}</h6>
								<p>Santa monica bullevard</p>
							</div>
							<div class="info_item">

								<i class="lnr lnr-home"></i>
								<h6>${demande.getAddress()}</h6>
								<p>Santa monica bullevard</p>
							</div>
							<div class="info_item">
								<i class="lnr lnr-phone-handset"></i>
								<h6>
									${demande.getCompte().getUser().getTel()} </a>
								</h6>
								<p>Mon to Fri 9am to 6 pm</p>
							</div>
							<div class="info_item">
								<i class="lnr lnr-envelope"></i>
								<h6>${demande.getService().getLibelle()}</h6>
								<p>Send us your query anytime!</p>
							</div>
							<div class="info_item">
								<i class="lnr lnr-graduation-hat"></i>
								<h6>
									${demande.getDescription()} </a>
								</h6>
								<p>Send us your query anytime!</p>
							</div>
							<div class="info_item">
					...
					<div class="col-lg-9">
						<form class="row contact_form" action="Send_msg2" method="GET"
							novalidate="novalidate">
							<div class="col-md-6">
								<img src="images/demande/${demande.getImage()} " weight="150%"
									height="150">
							</div>
