			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link d-block"
						href="Deconnexion"> Admin, <b>Logout</b>
					</a></li>
				</ul>
			</div>
		</div>
						...
						<table class="table table-hover tm-table-small tm-product-table">
							<thead>
								<tr>
									...
									<th scope="col">CATEGORIE ASSOCIEE</th>
							...
							<tbody>
								...
								<c:forEach items="${service}" var="ser">
									<tr>
										...
										<td class="tm-product-name">${ser.getLibelle()}</td>
										<td>${ser.getCat().getCat()}</td>
							...
							<tbody>
								<c:forEach items="${cat}" var="c">
									<tr>
										...
										<td class="tm-product-name">${c.getCat()}</td>
