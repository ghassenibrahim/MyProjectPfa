								...
								<div class="col-md-12">
									...
									<div class="panel panel-primary">
										...
										<table class="table table-hover">
											...
											<tbody>
												<c:forEach items="${contrat_reçu}" var="c">
													<c:choose>
													...
													<td>${c.getId()}</td>
													<td>${c.getCompte().getUser().getNom()}
														${c.getCompte().getUser().getPrenom()}</td>
													<td>${c.getCompte().getUser().getTel()}</td>
													<td>${c.getAddress()}</td>
													<td>${c.getDate()}</td>

													<td><a class="btn btn-info"
														href="DetailContrat?id=${c.getId()}"> <span
															class="glyphicon glyphicon-envelope"></span>
													</a> <a class="btn btn-success"
														href="AcceptContrat?id=${c.getId()}"> <span
															class="glyphicon glyphicon-ok"></span>
													</a> <a class="btn btn-danger"
														href="DeleteContrat?id=${c.getId()}"> <span
