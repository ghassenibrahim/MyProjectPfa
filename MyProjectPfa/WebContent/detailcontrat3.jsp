									...
									<div class="form-group">
										...
										<label for="name" class="control-label">*Destinataire:<font
											color="red"> ${c.getCompte().getUser().getNom()}
												${c.getCompte().getUser().getPrenom()}</font></label> </br> <label for="name"
											class="control-label">*Email:<font color="red">
												${c.getCompte().getEmail()}</font></label> </br> <label for="name"
											class="control-label">*Tel:<font color="red">
												${c.getCompte().getUser().getTel()}</font></label> </br> <label for="name"
											class="control-label">*Service consulte :<font
											...
											travaux:<font color="red"> ${c.getDate()}</font> *heure:<font
											color="blue"> ${c.getTime()}</font>
										</label>
