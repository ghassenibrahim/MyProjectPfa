...
<body data-spy="scroll" data-target=".site-navbar-target"
  ...
  <label for="name" class="control-label">*Destinataire:<font
												color="red"> ${c.getDispo().getCompte().getUser().getNom()}
														${c.getDispo().getCompte().getUser().getPrenom()}</font></label>
														  		            
		                        </br>
		         <label for="name" class="control-label">*Email:<font
												color="red"> ${c.getDispo().getCompte().getEmail()}</font></label>
		           	            		        </br>    		            
		                       
		         <label for="name" class="control-label">*Tel:<font
												color="red"> ${c.getDispo().getCompte().getUser().getTel()}</font></label>
												 </br> 
