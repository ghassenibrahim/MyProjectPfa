							...
							<div class="col-md-9">
								...
								<div class="col-md-12">
									<div class="alert alert-danger">
										<h4>Vous avez ${size} nouveaux messages</h4>
									</div>
								...
								<div class="col-md-12">
										...
										<div class="panel panel-primary">
											...
											<table class="table table-hover">
												...
												<tbody>
												<c:forEach items="${msg_reçu}" var="msg">
												<c:choose>
												<c:when test="${msg.getReceiveread()==0}">
													...
													<tr class="bg white">
															...
															<td>${msg.getSender().getUser().getNom()}
																${msg.getSender().getUser().getPrenom()}</td>
															<td>${msg.getSender().getEmail()}</td>
															<td>${msg.getMessage()}</td>
															<td>${msg.getDate()}</td>

															<td><a class="btn btn-info"
																href="DetailMsg?id=${msg.getId()}"> <span
																	class="glyphicon glyphicon-envelope"></span>
															</a> <a class="btn btn-danger"
																href="DeleteMsg?id=${msg.getId()}"> <span
