...
<link
	...
	rel="stylesheet">
<link href="w/w.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="site-wrap" id="home-section">
					...
					<div class="col-9  text-right">
						...
						<nav class="site-navigation text-right ml-auto d-none d-lg-block"
							...
							<ul class="site-menu main-menu js-clone-nav ml-auto ">
								...
								<c:choose>
									<c:when test="${id3>0}">
										<li class="active"><a href="Messagerie?id=${id3}"
											class="nav-link">BoiteMsg(${size })</a></li>
									</c:when>
									<c:otherwise>
						...
						<form class="trip-form" method="GET">
							...
							<div class="blog_right_sidebar">
								...
								<aside class="single-sidebar-widget tag_cloud_widget">
									...
									<ul class="list">
										<li><a href="ListeBricoleur">Tout les specialites</a></li>

										<c:forEach items="${service}" var="service">
											<li><a href='ListeBricoleur?id=${service.id}'>${service.libelle}</a>
											</li>
										</c:forEach>
									</ul>
								</aside>
		...
		<div class="site-section bg-light">
			<div class="container">
				<div class="row">
					<c:forEach items="${liste}" var="promo">
						...
						<div class="col-lg-4 col-md-6 mb-4">
							...
							<div class="item-1"  >
								...
								<a href="#"><img
									src="images/fournisseur/${promo.getCompte().getUser().getImage()}.jpg"
									width="100%" height="200" alt="Image"></a>
									
								<div class="item-1-contents"  >
								<c:choose>
									<c:when test="${promo.getDispo()==0}">
									<div id="test">BUSY</div>
									</c:when>
									</c:choose>
									<div class="text-center">
										...
										<h1>
											<font color="#ff8c1a">${promo.getResult(promo.getRating()*2/promo.getNbre_rating())}
											</font><font color="#e6e6e6">/10</font>
										</h1>
										<div class="rating-box">
											<div class="rating"
												style="width: ${promo.getRating()*20/(promo.getNbre_rating())}%;"></div>
										</div>
										<font color="#e6e6e6">(${promo.getNbre_rating()})avis</font>
									...
									<ul class="specs">
										...
										<li><span> Nom et Prenom</span><span class="spec">
												${promo.getCompte().getUser().getNom()}
												${promo.getCompte().getUser().getPrenom()}</span></li>
										<li><span>Tel</span> <span class="spec">
												${promo.getCompte().getUser().getTel()}</span></li>
										<li><span>Adress</span><span class="spec">${promo.getCompte().getUser().getCountry()}
												${promo.getCompte().getUser().getCity()} </span></li>
										<li><span>Experience</span> <span class="spec">${promo.getCompte().getUser().getExperience()}</span></li>
									</ul>
									<div class="d-flex action">
										<a href="Contact?id=${promo.getId()}" class="btn btn-primary">Contacter</a>
										<a href="Devi1?id=${promo.getId()}" class="btn btn-danger">Realiser
											un dévis</a>
									</div>
								</div>
