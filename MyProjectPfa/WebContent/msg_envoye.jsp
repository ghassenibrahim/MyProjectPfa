						...
						<div class="row">
							<div class="col-md-3">
								<div class="list-group">
									<a href="Msg" class="list-group-item success "> <span
										class="glyphicon glyphicon-envelope"> </span> Messages réçus <span
										class="badge badge-warning"> ${size}</span>
									</a> <a href="MsgEnvoye" class="list-group-item success">
										<span class="glyphicon glyphicon-check"> </span> Messages
										envoyés <span class="badge badge-warning"> ${size1} </span>
									</a> <a href="" class="list-group-item success"> <span
										class="glyphicon glyphicon-th"> </span> Messages Archivés <span
										class="badge badge-warning">200</span>
									</a> <a href="" class="list-group-item list-group-item-danger">
										<span class="glyphicon glyphicon-trash"> </span> Messages
							...
							<div class="col-md-9">
									...
									<div class="col-md-12">
										<div class="panel panel-primary">
											<div class="panel-heading">Liste des Messages Envoyes</div>
											<table class="table table-hover">
												...
												<tbody>
													<c:forEach items="${msg_envoye}" var="msg">
														<c:choose>
															<c:when test="${msg.getReceiveread()==0}">
																<tr class="bg info">
															</c:when>
															<c:otherwise>
																<tr class="bg white">
														...
														<td>${msg.getReceiver().getUser().getNom()}
															${msg.getReceiver().getUser().getPrenom()}</td>
														<td>${msg.getReceiver().getEmail()}</td>
														<td>${msg.getMessage()}</td>
														<td>${msg.getDate()}</td>

														<td><a class="btn btn-info"
															href="detail_msg.php?id=${msg.getId()}"> <span
																class="glyphicon glyphicon-envelope"></span>
														</a> <a class="btn btn-danger"
															href="DeleteReceive?id=${msg.getId()}"> <span
