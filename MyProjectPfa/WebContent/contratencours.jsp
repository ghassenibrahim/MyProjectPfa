								...
								<div class="col-md-12">
									...
									<div class="panel panel-primary">
										...
										<table class="table table-hover">
											...
											<tbody>
												<c:forEach items="${intervention_en_cours_execution}" var="c">
													
															<tr class="bg-success">
														
													<td>${c.getContrat().getId()}</td>
													<td>${c.getContrat().getCompte().getUser().getNom()}
														${c.getContrat().getCompte().getUser().getPrenom()}</td>
													<td>${c.getContrat().getCompte().getUser().getTel()}</td>
													<td>${c.getContrat().getAddress()}</td>
													<td>${c.getContrat().getDate()}</td>

													<td><a class="btn btn-info"
														href="DetailContrat1?id=${c.getContrat().getId()}"> <span
