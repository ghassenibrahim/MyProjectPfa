						...
						<div class="row">
							<div class="col-md-3">
								<div class="list-group">
									...
									</a> <a href="MsgEnvoye" class="list-group-item success"> <span
										class="glyphicon glyphicon-check"> </span> Messages envoyés <span
							...
							<div class="col-md-9">
								<c:forEach items="${msg}" var="msg">
									...
									<c:choose>
										<c:when test="${msg.getReceiver().getId()==compte.getId()}">
									...
									<a class="btn btn-danger  " href="DeleteMsg?id=${msg.getId()}"> <span
										class="glyphicon glyphicon-trash"></span>
									</a> ${msg.getSender().getUser().getNom()}
											${msg.getSender().getUser().getPrenom()}

											<h3>
										<p style="color: #0e8f00";>${msg.message}</p>
									</h3>

									<p style="color: #f42300">envoyé le: ${msg.getDate()}</p>
							</div>
							</c:forEach>
							<form action="Send_msg" method="GET" novalidate="novalidate">
