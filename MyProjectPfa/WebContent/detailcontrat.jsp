		...
		<div class="ftco-blocks-cover-1">
			...
			<form class="form-horizontal templatemo-contact-form-1" role="form" action="#" method="post">
				<div class="form-group">
		            ...
		            <label for="name" class="control-label">*Destinataire:<font
												color="red"> ${c.getCompte().getUser().getNom()}
														${c.getCompte().getUser().getPrenom()}</font></label>
														  		            
		                        </br>
		         <label for="name" class="control-label">*Email:<font
												color="red"> ${c.getCompte().getEmail()}</font></label>
		           	            		        </br>    		            
		                       
		         <label for="name" class="control-label">*Tel:<font
												color="red"> ${c.getCompte().getUser().getTel()}</font></label>
												 </br> 
												     <label for="name" class="control-label">*Service consulte :<font
												color="red"> ${c.getDispo().getService().getLibelle()}</font></label>
												 </br> 
												  
														  	            
		                       
		         <label for="name" class="control-label">*Description :<font
												color="red"> ${c.getDescription()}</font></label>
												 </br>
												  <label for="name" class="control-label">*Adress du travaux:<font
												color="red"> ${c.getAddress()}</font></label>  
												  </br> 
												   <label for="name" class="control-label">*Prix propose:<font
												color="red"> ${c.getPrix()}</font> dinars/heure</label> 
												 </br> 
												   <label for="name" class="control-label">*Date travaux:<font
												color="red"> ${c.getDate()}</font>   *heure:<font
												color="blue"> ${c.getTime()}</font></label>  
		        <div class="form-group">
		          <div class="col-md-12">
		            <div class="checkbox">
		                <label>
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		            ...
		            <a class="btn btn-success"
														href="AcceptContrat?id=${c.getId()}"> Accept
													</a> 
		          </div>
		        </div>		    	
		      </form>		      
