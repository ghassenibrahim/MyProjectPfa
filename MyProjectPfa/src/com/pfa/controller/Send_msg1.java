...
/**
 * Servlet implementation class Send_msg1
 */
@WebServlet("/Send_msg1")
public class Send_msg1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Disponibilite dispo=dao2.getDisponibiliteById(id1);
		...
		Compte receiver=dispo.getCompte();
