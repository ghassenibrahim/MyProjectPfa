...
/**
 * Servlet implementation class Send_msg4
 */
@WebServlet("/Send_msg4")
public class Send_msg4 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id1 = (int) session.getAttribute("contact_id");
		...
		response.sendRedirect("http://localhost:8085/MyProjectPfa/Messagerie?id=" + id1 + "");
