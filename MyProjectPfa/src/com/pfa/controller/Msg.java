...
public class Msg extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id=compte.getId();
		List<Message>msg_reçu=dao1.getAllMessageRecus(id);
		...
		request.setAttribute("msg_reçu", msg_reçu);
		...
		//request.getRequestDispatcher("msg_reçus.jsp").forward(request,response);
	}
