...
/**
 * Servlet implementation class Contrat
 */
@WebServlet("/ListeContrat")
public class ListeContrat extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("listecontrat.jsp").forward(request, response);
