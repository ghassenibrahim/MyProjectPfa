...
/**
 * Servlet implementation class DetailMsgEnvoye
 */
@WebServlet("/DetailContratEnvoye")
public class DetailContratEnvoye extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DetailContratEnvoye() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("detailcontrat2.jsp").forward(request, response);
	}
